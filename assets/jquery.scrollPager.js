(function ($) {
    ...
    var defaults = {
        ...
        loadingTextWrapperClass: 'scroll-pager-loading-text',
        pjax: {
            container: '#scrollPagerContainer'
        },
        state: {
            isPaused: false,
    ...
    var methods = {
        ...
        start: function () {
            ...
            methods.bind();
            object.trigger('scrollPager:afterStart');
            return this;
        },
        stop: function () {
            options.state.isPaused = true;
            methods.unbind();
            object.trigger('scrollPager:afterStop');
            return this;
        },
        retrieve: function () {
                ...
                if (link.length) {
                    ...
                    $.ajax({
                        ...
                        success: function (text) {
                            options.state.tempHTML = $('<div>').append(text);
                            ...
                            // JS Init
                            $('body').append(options.state.tempHTML.find('script[type]'));
